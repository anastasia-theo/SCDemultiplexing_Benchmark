...
###### (kite from joined dataset and with linker anchor)
...
kite_fastq = "/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/raw_data/kite/joined_linker/joined_linker_kite.fastq"      # Smaller FASTQ file with 83M reads
output_fastq = "/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/raw_data/kite/joined_linker/joined_linker_merged.fastq"   # Output FASTQ for matched reads
missing_reads_log = "/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/raw_data/kite/joined_linker/joined_linker_merged_missing_reads.txt" # Log for missing reads
