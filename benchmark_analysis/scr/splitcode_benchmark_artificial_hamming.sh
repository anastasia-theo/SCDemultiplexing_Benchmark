#!/bin/bash
#SBATCH --job-name=splitcode_benchmark_artificial_hamming
#SBATCH --error=/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/results/splitcode_results/artificial_hamming/splitcode_benchmark_artificial_hamming_%A%a.err  # Error file location
#SBATCH --output=/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/results/splitcode_results/artificial_hamming/splitcode_benchmark_artificial_hamming_%A%a.out # Output file location
...
CONFIG_FILE="/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/raw_data/splitcode/config_artificial.txt"
...
FASTQ_FILE="/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/raw_data/artificial/hamming/mismatched_fastq_hamming.fastq"
RESULTS_DIR="/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/results/splitcode_results/artificial_hamming"
...
# If the tool runs successfully, extract time/memory usage
    ...
    # we first want to keep only the finds that contain all 3 variable barcodes
    # awk -F'\t' '{split($2, a, ","); if (length(a) == 5) print $0}' "$MAPPING_FILE" > "$MAPPING_FILTERED"
