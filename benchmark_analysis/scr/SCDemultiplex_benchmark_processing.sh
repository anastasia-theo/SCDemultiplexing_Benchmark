#!/bin/bash
#SBATCH --job-name=SCDemultiplex_benchmark_processing
#SBATCH --error=/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/results/SCDemultiplex_results/processing/new/SCDemultiplex_benchmark_processing_%A%a.err  # Error file location
#SBATCH --output=/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/results/SCDemultiplex_results/processing/new/SCDemultiplex_benchmark_processing_%A%a.out # Output file location
...
FASTQ_FILE="/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/results/SCDemultiplex_results/processing/Demultiplexed_MAPPING_1.tsv.gz"
...
ANTIBODY_FILE="/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/raw_data/tape_data/antibodies.txt"
RESULTS_DIR="/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/results/SCDemultiplex_results/processing/new"
THREAD_COUNT=60
OUTPUT_FILE="/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/results/SCDemultiplex_results/processing/new/ABCOUNT.tsv"
