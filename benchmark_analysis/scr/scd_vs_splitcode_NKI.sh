#!/bin/bash
#SBATCH --job-name=compare_scd_split_NKI
#SBATCH --error=/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/results/scd_vs_splitcode_NKI/compare_scd_split_NKI_%A%a.err
#SBATCH --output=/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/results/scd_vs_splitcode_NKI/compare_scd_split_NKI_%A%a.out
...
# Directories
SCD_DIR="/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/results/SCDemultiplex_results/NKI_dataset/60_threads"
SPLIT_DIR="/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/results/splitcode_results/NKI_dataset"
RESULTS_DIR="/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/results/scd_vs_splitcode_NKI"
...
COMPARE_SCRIPT="/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/scr/scd_vs_splitcode_NKI.py"
