#!/bin/bash
#SBATCH --job-name=SCDemultiplex_benchmark_artificial_hamming
#SBATCH --error=/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/results/SCDemultiplex_results/artificial_hamming/0_UMI/SCDemultiplex_benchmark_artificial_hamming_%A%a.err  # Error file location
#SBATCH --output=/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/results/SCDemultiplex_results/artificial_hamming/0_UMI/SCDemultiplex_benchmark_artificial_hamming_%A%a.out # Output file location
...
RESULTS_DIR="/scistor/informatica/ath100/SCDemultiplexing_Benchmark/benchmark_analysis/results/SCDemultiplex_results/artificial_hamming/0_UMI"
